...
if nav == "JOB":
    ...
    job_list = pickle.load(open('G:\My Drive\pythonProject\pythonProject\Job Recommendation engine\\job1_dict.pkl', 'rb'))
    job1 = pd.DataFrame(job_list)
    similarity = pickle.load(open('G:\My Drive\pythonProject\pythonProject\Job Recommendation engine\\similarity1.pkl', 'rb'))
